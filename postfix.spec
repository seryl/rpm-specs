...
Patch1: postfix-2.7.2-config.patch
Patch2: postfix-2.6.1-files.patch
Patch3: postfix-alternatives.patch
Patch8: postfix-large-fs.patch
# Postfix quota patch see http://vda.sourceforge.net/
Patch100: postfix-vda-v10-2.8.1.patch
...
%attr(0755, root, root) %{_libexecdir}/%{name}/postscreen
...
%changelog
* Sun Sep 04 2011 Denis Frolov <d.frolov81@mail.ru> 2:2.8.5-1
- update to 2.8.5

* Mon Jul 11 2011 Denis Frolov <d.frolov81@mail.ru> 2:2.8.4-1
- update to 2.8.4

* Thu May 10 2011 Denis Frolov <d.frolov81@mail.ru> 2:2.8.3-1
- update to 2.8.3

* Thu Mar 22 2011 Denis Frolov <d.frolov81@mail.ru> 2:2.8.2-1
- update to 2.8.2

* Wed Feb 23 2011 Denis Frolov <d.frolov81@mail.ru> 2:2.8.1-1
- update to 2.8.1

* Thu Feb 22 2011 Denis Frolov <d.frolov81@mail.ru> 2:2.8.0-1
- update to 2.8.0

* Thu Jan 11 2011 Denis Frolov <d.frolov81@mail.ru> 2:2.7.2-2
- update to 2.7.2

* Wed Nov 24 2010 Denis Frolov <d.frolov81@mail.ru> 2:2.6.8-1
- update to 2.6.8

* Wed Jun 09 2010 Denis Frolov <d.frolov81@mail.ru> 2:2.6.7-1
- update to 2.6.7

* Sat Mar 21 2010 Denis Frolov <d.frolov81@mail.ru> 2:2.6.6-1
- update to 2.6.6
- add postfix-2.6-milter-header-checks-20090607-patch.gz patch

* Thu Sep 15 2009 Denis Frolov <d.frolov81@mail.ru> 2:2.6.5-1
- update to 2.6.5

* Mon Jul 03 2009 Denis Frolov <d.frolov81@mail.ru> 2:2.6.2-1
- Add VDA patch
